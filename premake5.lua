...
project "gossipSim-nodeEditor"
	location "gossipSim-nodeEditor"
	kind "ConsoleApp"
	language "C++"
	cppdialect "C++20"
	staticruntime "on"
	...
	files
	{
		...
		"%{prj.name}/src/**.hpp",
		"%{prj.name}/application.cpp",
		"gossipSim/Dependencies/pugixml/pugixml.hpp",
		"gossipSim/Dependencies/pugixml/pugixml.cpp",
		"gossipSim/Dependencies/pugixml/pugiconfig.hpp"
	}

	includedirs
	{
		"gossipSim/Dependencies/pugixml",
		"gossipSim/Dependencies/Daedalus/Engine/Daedalus-Core",
		"gossipSim/Dependencies/Daedalus/Engine/Daedalus-Core/src",
		"gossipSim/Dependencies/Daedalus/Engine/Daedalus-Core/Dependencies/ImGui/include"
	}
